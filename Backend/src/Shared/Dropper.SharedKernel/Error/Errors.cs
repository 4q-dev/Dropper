...
public static class Errors
{
    public static class File
    {
        ...
        public static Error IncorrectFile(string? message = null) =>
            Error.Validation("file.is.invalid", message ?? "Incorrect file");
    }
    ...
    public static class UserRestriction
    {
        ...
        {
            return Error.Authorization("user.banned.access.denied",
                $"Access denied for banned user with ID '{userId}'.");
        }
    ...
    public static class VolunteerRequest
    {
        ...
        {
            return Error.Conflict("volunteer.request.update.failed",
                "To update an application, it needs to have a status of 'Corrections Needed'");
        }
